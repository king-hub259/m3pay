...
class RouteHelper {
  ...
  static  getLoginRoute({required String? countryCode, required String? phoneNumber, required String? userName}) {
  ...
  static  getNavBarRoute({String? selectedPage}) => (selectedPage?.isNotEmpty ?? false) ? '$navbar?selectedPage=$selectedPage' : navbar;
