...
import 'package:six_cash/common/widgets/custom_selection_dialog.dart';
      ...
      child = InkWell(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            if (!widget.hideMainText!)
            Container( margin : const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
              width: 1, height: 15, color: Theme.of(context).textTheme.bodySmall?.color?.withValues(alpha:0.4),
            )
          ],
        ),
      );
