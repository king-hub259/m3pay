...
class _TransactionMoneyScreenState extends State<TransactionMoneyScreen> {
  ...
  Widget build(BuildContext context) {
     ...
     return Scaffold(
      ...
      body: GetBuilder<ContactController>(builder: (contactController) => CustomScrollView(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: GetBuilder<ContactController>(builder: (checkController) {
                            return checkController.isLoading || checkController.isContactListLoading ? SizedBox(
