          ...
          bottom: PreferredSize(
            ...
            child: Container(
              ...
              child: TabBar(
                ...
                unselectedLabelColor: Theme.of(context).primaryColor.withValues(alpha:0.5),
                ...
                indicatorColor: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha:0.7),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        // boxShadow: [
        //   BoxShadow(blurRadius: 10, offset: Offset(0,0), color: Color(0xFF56C50D).withValues(alpha:0.05))
        // ],
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(flex: 3, child: Container(
              ...
              decoration: BoxDecoration(
                border: Border(right: BorderSide(color: Theme.of(context).primaryColor.withValues(alpha:0.1), width: 1)),
              ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Column(children: [
          Text(title, style: rubikRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha:0.7))),
          const SizedBox(height: Dimensions.paddingSizeSmall),
