  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: ColorResources.getBlackAndWhite().withValues(alpha:0.5), blurRadius: 80, offset: const Offset(0, 20)),
          ],
      ),
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('my_qr_code'.tr,style: rubikRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: ColorResources.getBlackAndWhite().withValues(alpha:0.6),)),
          ),
